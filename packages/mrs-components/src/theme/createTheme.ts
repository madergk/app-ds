  ...
  const themeOptions: ThemeOptions = {
    ...
    components: {
      ...
      MuiInputLabel: {
        styleOverrides: {
          root: {
            ...
            lineHeight: `${typographyVariants.input.label.lineHeight}px`,
            '&.Mui-focused': {
      ...
      MuiTextField: {
        styleOverrides: {
          root: {
            // TextField styling is handled by its underlying components
            // (InputBase, InputLabel, FormHelperText, etc.)
          },
        },
      },
      MuiFormControl: {
        styleOverrides: {
          root: {
            // FormControl styling is minimal, mainly provides context
          },
        },
      },
      MuiFormLabel: {
      ...
      MuiFormGroup: {
        styleOverrides: {
          root: {
            // FormGroup styling is minimal, mainly provides layout
          },
        },
      },
      MuiFormControlLabel: {
      ...
      MuiInputAdornment: {
        styleOverrides: {
          root: {
            // InputAdornment styling is minimal
            '& .MuiSvgIcon-root': {
              fontSize: 24,
            },
          },
      ...
      MuiAutocomplete: {
        styleOverrides: {
          ...
          tag: {
            ...
            fontSize: `${typographyVariants.chip.label.fontSize}rem`,
            fontWeight: typographyVariants.chip.label.fontWeight,
            lineHeight: `${typographyVariants.chip.label.lineHeight}px`,
            height: 24,
            margin: '3px 4px',
      ...
      MuiLinearProgress: {
        styleOverrides: {
          root: {
            ...
            backgroundColor: hexToRgba(primitiveColors.black, opacityValues.disabled),
          },
          bar: {
            borderRadius: primitiveRadius.rounded,
          },
